...
public class CiudadAction extends ActionSupport {
	...
	@Action(value = "AListado", 
			results = { @Result(name = "success", location = "/listado.jsp") })
	...
	@Action(value = "AGrabar", 
			results = { @Result(name = "success", location = "AListado", type = "redirectAction") })
